...
#define BST_DEVICE_NAME "/dev/null"
#define BST_SENSOR_NUM_MAX 8
#define BST_DATA_POLL_TIMEOUT 500000

#define SENSORS_ACCELERATION_HANDLER			0
#define SENSORS_MAGNETIC_FIELD_HANDLER		1
#define SENSORS_ORIENTATION_HANDLER			2
#define SENSORS_LIGHT_HANDLER					4
#define SENSORS_PROXIMITY_HANDLER			5
#define SENSORS_GYROSCOPE_HANDLER			6
#define SENSOR_TEMPERATURE_HANDLER			7
...
class BstSensor : public SensorBase {
	public:
		...
		virtual int enable(int32_t handle, int enable);
